...
export default function HomeHero() {
  const title = "Structurer aujourd'hui les outils qui soutiendront votre croissance.";

  const subtitle = "Conception, modernisation et développement de solutions web.";

  return (
    <HeroParallax title={title} subtitle={subtitle}>
