    ...
    <main className="min-h-screen bg-background text-foreground">
        ...
        <Container className="xl:w-[65%] text-center">
          ...
          <ScrollReveal>
            <p className="text-text-medium leading-relaxed max-w-2xl mx-auto">
              Chaque projet est conçu comme un système structuré, capable d’évoluer avec votre
              organisation. Nous privilégions performance, cohérence et vision stratégique.
            </p>
          </ScrollReveal>
        </Container>
      </section>
      ...
      <section className="py-24 bg-background">
        <Container className="xl:w-[60%] text-center">
          <ScrollTitle>
            <h2 className="text-3xl font-semibold mb-10">Plus qu’un site, une base durable.</h2>
          </ScrollTitle>

          <ScrollReveal>
            <p className="text-text-medium leading-relaxed max-w-2xl mx-auto">
              Nous ne livrons pas simplement une interface. Nous concevons une architecture durable,
