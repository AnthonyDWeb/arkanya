...
export default function Solutions() {
  ...
  return (
    <main className="bg-background text-foreground">
      <Hero
        image="/page/solutions-hero.webp"
        title={herotitle}
        ...
        <div className="w-[90%] xl:w-[60%] mx-auto text-center">
          ...
          <FadeIn delay={0.1}>
            <p className="text-text-medium leading-relaxed">
              Chaque projet est conçu comme un système digital structuré, capable d’évoluer avec
            ...
            {solutions.map((solution, index) => (
              <FadeIn key={solution.title} delay={index * 0.05}>
                <Card href={solution.slug}>
                  <h3 className="text-xl font-semibold mb-4 text-center transition-colors group-hover:text-white group-active:text-white group-focus-visible:text-white">
                    {solution.title}
                  </h3>
      ...
      <section className="premium-final-cta text-white text-center">
        <div className="w-[90%] xl:w-[60%] mx-auto">
          <FadeIn>
            <h2 className="text-3xl font-semibold mb-6">Discutons de votre projet</h2>
          </FadeIn>

          <FadeIn delay={0.1}>
            <p className="text-white/80 mb-10">
              Un échange permet d’identifier rapidement la solution adaptée à votre organisation.
            </p>
          </FadeIn>
