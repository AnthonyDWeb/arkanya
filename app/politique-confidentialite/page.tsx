            ...
            <div className="w-[90%] max-w-4xl mx-auto space-y-12">
                ...
                <header className="space-y-4">
                    ...
                    <p className="text-neutral-500">
                        ...
                        sont collectées et utilisées sur le site arkanya.fr.
                    </p>
                </header>
                ...
                <section className="space-y-6">
                    ...
                    <p>
                        Les données peuvent être collectées lorsque vous
                ...
                <section className="space-y-6">
                    ...
                    <p>
                        Les données sont conservées uniquement le temps
                        nécessaire à la gestion de la relation commerciale
                        et dans la limite de trois ans.
                    </p>
                </section>
                ...
                <section className="space-y-6">
                    ...
                    <p>
                        ...
                        de suivi publicitaire ou analytique.
                    </p>
                </section>
