            ...
            <div className="w-[90%] max-w-4xl mx-auto space-y-12">
                ...
                <header className="space-y-4">
                    ...
                    <p className="text-neutral-500 leading-relaxed">
                        Les présentes mentions légales ont pour objectif d’informer
                        les utilisateurs du site arkanya.fr sur l’identité de son
                        éditeur, son hébergement ainsi que les conditions
                ...
                <section className="space-y-6">
                    ...
                    <p>
                        ...
                        <strong> Anthony Delforge</strong>, entrepreneur individuel
                        exerçant sous le nom commercial <strong>Arkanya</strong>.
                    </p>

                    <p>
                        Arkanya propose des prestations de développement web,
                        de création de sites internet et de solutions digitales
                        destinées aux entreprises souhaitant structurer ou faire
                        évoluer leurs outils numériques.
                    </p>
                    ...
                    <p>
                        Directeur de la publication : Anthony Delforge.
                    </p>
                </section>
                ...
                <section className="space-y-6">
                    ...
                    <p className="text-neutral-700">
                        Le nom de domaine arkanya.fr est enregistré auprès de la
                        société OVH SAS.
                    </p>
                </section>
                ...
                <section className="space-y-6">
                    ...
                    <p>
                        ...
                        graphismes, logo, structure, code source, etc.) est protégé
                        par les lois relatives à la propriété intellectuelle.
                    </p>

                    <p>
                        Toute reproduction, représentation, modification,
                        publication ou adaptation de tout ou partie des éléments
                ...
                <section className="space-y-6">
                    ...
                    <p>
                        ...
                        à titre indicatif. L’éditeur s’efforce de fournir
                        des informations aussi précises que possible,
                        mais ne peut garantir l’exactitude, la complétude
                ...
                <section className="space-y-6">
                    ...
                    <p>
                        ...
                        L’éditeur ne peut être tenu responsable du contenu
